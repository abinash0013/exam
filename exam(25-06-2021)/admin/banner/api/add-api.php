<?php
    ...
    $insert = $con->query("INSERT INTO `tbl_banner`(`title`, `description`, `titleHi`, `descriptionHi`, `image`, `createdAt`) VALUES ('$bannerTitle','$bannerDescription','$bannerTitleHi','$bannerDescriptionHi','$path',now())");

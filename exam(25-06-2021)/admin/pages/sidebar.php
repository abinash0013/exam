    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li>
                    <a
                        href="./../chapter/index.php"
                        class="dropdown-toggle no-arrow"
                    >
                        <span class="micon dw dw-house-1"></span
                        ><span class="mtext">Chapter</span>
                    </a>
                </li>
                <li>
                    <a
                ...
                <li>
                    <a
                        href="./../liveClasses/index.php"
                        class="dropdown-toggle no-arrow"
                    >
                        <span class="micon dw dw-house-1"></span
                        ><span class="mtext">Live Classes</span>
                    </a>
                </li>
                <li>
                    <a
                ...
                <li>
                    ...
                    >
                        <span class="micon dw dw-house-1"></span
                        ><span class="mtext">Pdf</span>
                    </a>
                </li>
                <li>
                    <a
                        href="./../purchase/index.php"
                        class="dropdown-toggle no-arrow"
                    >
                        <span class="micon dw dw-house-1"></span
                        ><span class="mtext">Purchase</span>
                    </a>
                </li>
                <li>
                    <a
                        href="./../promotionPdf/index.php"
                        class="dropdown-toggle no-arrow"
                    >
                        <span class="micon dw dw-house-1"></span
                        ><span class="mtext">Promotion Pdf</span>
                    </a>
                </li>
                <li>
                    <a
                        href="./../promotionVideo/index.php"
                        class="dropdown-toggle no-arrow"
                    >
                        <span class="micon dw dw-house-1"></span
                        ><span class="mtext">Promotion Video</span>
                    </a>
                </li>
                <li>
                    <a
                        href="./../subject/index.php"
                        class="dropdown-toggle no-arrow"
                    >
                        <span class="micon dw dw-house-1"></span
                ...
                <li>
                    <a
                        href="./../topper/index.php"
                        class="dropdown-toggle no-arrow"
                    >
                        <span class="micon dw dw-house-1"></span
                        ><span class="mtext">Topper</span>
                    </a>
                </li>
                <li>
                    <a

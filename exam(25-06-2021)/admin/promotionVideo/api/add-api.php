<?php
    ...
    $insert = $con->query("INSERT INTO `tbl_videos`(`videoTitle`, `videoDescription`, `videoTitleHi`, `videoDescriptionHi`, `videoUrl`, `chapterId`, `subjectId`, `courseId`, `videoImage`, `lessonNumber`, `videoType`, `createdAt`) VALUES ('$videoTitle','$videoDescription','$videoTitleHi','$videoDescriptionHi','$videoUrl','$chapterId','$subjectId','$courseId','$path','$lessonNumber','promotion',now())");

		...
		<div class="min-height-200px">
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Promotion Video Add</li>
							</ol>
						</nav>
					</div>
			...
			<div class="pd-20 card-box mb-30">
			    <div class="alert alert-success" role="alert" id="successAlert" style="display:none">
                    Successfully Added a New Promotion Video
                </div>
				<div class="clearfix">
					<div class="pull-left">
						<h4 class="text-blue h4">Add Promotion Video Form</h4>
					</div>
				</div>
				<form id="dataform" method="post">
					...
					<button type="submit" id="btnsubmit" class="btn btn-primary">Add Promotion Video</button>
				</form>
			</div>

<?php
    ...
    $insert = $con->query("UPDATE `tbl_pdf` SET `pdfTitle`='$pdfTitle',`pdfDescription`='$pdfDescription',`pdfTitleHi`='$pdfTitleHi',`pdfDescriptionHi`='$pdfDescriptionHi',`pdfUrl`='$pathFile',`pdfImage`='$path',`pdfType`='promotion',`updatedAt`= now() WHERE pdfId=$pdfId");

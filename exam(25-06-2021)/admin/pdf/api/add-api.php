<?php
    ...
    $insert = $con->query("INSERT INTO `tbl_pdf`(`pdfTitle`, `pdfDescription`, `pdfTitleHi`, `pdfDescriptionHi`, `pdfUrl`, `chapterId`, `subjectId`, `courseId`, `pdfimage`, `createdAt`) VALUES ('$pdfTitle','$pdfDescription','$pdfTitleHi','$pdfDescriptionHi','$pathFile','$chapterId','$subjectId','$courseId','$path',now())");

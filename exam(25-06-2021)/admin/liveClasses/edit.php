                    ...
                    <?php foreach($result as $value) { ?>    
    					...
    					<div class="row">
        					<div class="form-group col-6">
        						...
        						<input class="form-control" type="text" name="startedDate" id="startedDate" placeholder="Started Date" onfocus="(this.type='date')" value="<?php echo $value['start_date']; ?>" required>
        					</div>
        					<div class="form-group col-6">
        						<label>End Date</label>
        						<input class="form-control" type="text" name="endDate" id="endDate" placeholder="End Date" onfocus="(this.type='date')" value="<?php echo $value['end_date']; ?>" required>
        					</div>
    					</div>
    					<div class="row">
        					<div class="form-group col-6">
        						<label>Start Time</label>
        						<input class="form-control" type="text" name="startedTime" id="startedTime" placeholder="Started Time" onfocus="(this.type='time')" value="<?php echo $value['start_time']; ?>" required>
        					</div>
        					<div class="form-group col-6">
        						<label>End Time</label>
        						<input class="form-control" type="text" name="endTime" id="endTime" placeholder="End Time" onfocus="(this.type='time')" value="<?php echo $value['end_time']; ?>" required>
        					</div>
    					</div>

...
<!-- :::::::::::::::::::::::::::::::::::> Fetch Data Start <::::::::::::::::::::::::::::::::::: -->
<?php 
    $resultdata = $con->query("SELECT tbl_videos.*, tbl_chapter.chapterName as chname, tbl_chapter.chapterNameHi as chnamehi, tbl_subject.subjectName as sname, tbl_subject.subjectNameHi as snamehi, tbl_course.courseName as cname, tbl_course.courseNameHi as cnamehi FROM tbl_videos LEFT JOIN tbl_chapter on tbl_videos.chapterId = tbl_chapter.chapterId LEFT JOIN tbl_subject on tbl_subject.subjectId = tbl_videos.subjectId LEFT JOIN tbl_course on tbl_course.courseid = tbl_videos.courseId where videoType='live' order by videoId DESC");
    $result = array();
	...
	<div class="pd-ltr-20 xs-pd-20-10">
		<div class="min-height-200px">
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Live Classes List</li>
							</ol>
						</nav>
					</div>
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<a class="btn btn-primary" href="add.php" role="button">
								Add Live Classes <i class="icon-copy ion-plus-round"></i>
							</a>
						</div>
					</div>
				</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4">List of Live Classes</h4>
				</div>
				<div class="pb-20">

...
<!-- :::::::::::::::::::::::::::::::::::> Fetch Data Start <::::::::::::::::::::::::::::::::::: -->
<?php 
    $resultdata = $con->query("SELECT * FROM `tbl_contact` order by id desc");
    $result = array();
	...
	<div class="pd-ltr-20 xs-pd-20-10">
		<div class="min-height-200px">
					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<a class="btn btn-primary" href="add.php" role="button">
								Add Contact <i class="icon-copy ion-plus-round"></i>
							</a>
						</div>
					</div>
				</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4">List of Contact</h4>
				</div>
				<div class="pb-20">
						...
						<tbody>
                            ...
                            <?php foreach($result as $value){ ?>
							    <tr>
									...
									<td class="table-plus"><?php echo $value['contactName']?></td>

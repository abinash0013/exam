<?php
   ...
   function coursePurchase(){
            ...
            // $this->purchaseExpaireDate=htmlspecialchars(strip_tags($this->purchaseExpaireDate));
            // $this->purchaseAmount=htmlspecialchars(strip_tags($this->purchaseAmount));
            // $this->status=htmlspecialchars(strip_tags($this->status));
            // $this->courseName=htmlspecialchars(strip_tags($this->courseName)); 
            //  $this->courseNameHi=htmlspecialchars(strip_tags($this->courseNameHi));
            // $this->courseDescriptionHi=htmlspecialchars(strip_tags($this->courseDescriptionHi));
            // $this->statusHi=htmlspecialchars(strip_tags($this->statusHi)); 
